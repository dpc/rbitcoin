...
| **Q-60** | Keep rank 6. Prefill monotonic + `held_seq` + WS `spawn_blocking` + outbound asmap/prefix diversity landed. IBD getaddr inject 4096 + last-resort eviction. AddrMan new/tried buckets and `announced_wtx` roll still open. |
