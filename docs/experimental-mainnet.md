...
**Status:** **0.5.99** (pre-0.6.0) is lab-to-operator: **early production / high-scrutiny**,
...
| Not Core/Fulcrum | No production SLA; 0.5.99 is high-scrutiny 0.x; schema unstable until 1.0; reindex on incompatible layout changes |
