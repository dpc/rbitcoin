...
**Today (0.5.99):** in-tree toward **0.6.0**. Last published tags are
**0.5.1** and the **0.5.2** maintenance branch (off 0.5.1). Schema **20**
...
0.5.99 / 0.6 can ship any remaining gate without freezing the store.
